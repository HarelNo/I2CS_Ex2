 ...
 *  and represented in degrees. For example.txt, {@code StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  For example.txt, the following code fragment draws a filled diamond
 ...
 *  </ul>
 *  <p>
 *  For example.txt, {@code StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example.txt, {@code StdDraw.setPenColor(StdDraw.MAGENTA)} sets the
 ...
 *  For example.txt, {@code StdDraw.setCanvasSize(800, 800)}
 ...
 *  For example.txt, if you  wish to use the default coordinate system but
 ...
 *  choose the face, size, and style of the font. For example.txt, the following
 ...
 *  allows you to specify a color of your choice. For example.txt,
 ...
 *  <p>
 *  For example.txt, this code fragment animates two balls moving in a circle.
 *  <pre>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * @param  angle2 the angle at the end of the arc. For example.txt, if
